...
const OPPORTUNITES: Opp[] = [
  ...
  },
  {
    ...
    langueDetectee: "en", conditions: "Être admissible à un programme de 2e ou 3e cycle à McGill. Avoir démontré un leadership exceptionnel, un engagement communautaire et une excellence académique.",
  ...
  // ═══════════════════════════════════ ALLEMAGNE ═══════════════════════════════════
  {
    ...
    langueDetectee: "en", conditions: "Diplôme de licence (4 ans). Minimum 2 ans d'expérience professionnelle après le diplôme. Être ressortissant d'un pays en développement (liste DAC).",
  ...
  },
  {
    ...
    langueDetectee: "en", conditions: "Ressortissant d'un pays d'Afrique subsaharienne. Diplôme de licence avec bons résultats. Admission dans une université partenaire DAAD en Afrique.",
  ...
  },
  {
    ...
    langueDetectee: "en", conditions: "Être étudiant international non-chinois. Bons résultats académiques. Être admis dans une université du Zhejiang.",
  ...
  },
  {
    ...
    langueDetectee: "en", conditions: "Être ressortissant d'un pays éligible VLIR-UOS (inclut Bénin, Burkina Faso, Cameroun, RD Congo, Éthiopie, etc.). Maximum 35 ans. Expérience professionnelle pertinente.",
  ...
  },
  {
    ...
    langueDetectee: "en", conditions: "Être admis dans un programme de master éligible dans une université flamande. Ne pas avoir étudié en Belgique auparavant.",
    piecesExigees: `[{"nom":"Lettre de motivation","type":"lettre","categorie":"generable","obligatoire":true},{"nom":"CV","type":"cv","categorie":"generable","obligatoire":true},{"nom":"Relevés de notes","type":"releves","categorie":"personnel","obligatoire":true}]`,
  ...
  // ═══════════════════════════════════ LUXEMBOURG ═══════════════════════════════════
  {
    ...
    langueDetectee: "en", conditions: "Être étudiant international à temps plein. Excellents résultats académiques. Ne pas bénéficier de l'aide financière de l'État luxembourgeois.",
    piecesExigees: `[{"nom":"Lettre de motivation","type":"lettre","categorie":"generable","obligatoire":true},{"nom":"CV","type":"cv","categorie":"generable","obligatoire":true},{"nom":"Relevés de notes","type":"releves","categorie":"personnel","obligatoire":true}]`,
  ...
  // ═══════════════════════════════════ BOURSE PEARSON (CANADA) ═══════════════════════════════════
  {
    ...
    langueDetectee: "en", conditions: "Être étudiant international. Être nominé par son école secondaire. Excellence académique et créativité démontrées. Être en dernière année du secondaire ou première année post-bac.",
  ...
  // ═══════════════════════════════════ ADMISSION ALLEMAGNE ═══════════════════════════════════
  {
    ...
    langueDetectee: "en", conditions: "Licence pertinente (bachelor). Bons résultats académiques (top 20% de la promotion recommandé). Admission compétitive.",
    piecesExigees: `[{"nom":"Lettre de motivation","type":"lettre","categorie":"generable","obligatoire":true},{"nom":"CV","type":"cv","categorie":"generable","obligatoire":true},{"nom":"Relevés de notes","type":"releves","categorie":"personnel","obligatoire":true},{"nom":"Certificat de langue","type":"langue","categorie":"personnel","obligatoire":true}]`,
