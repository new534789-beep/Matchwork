...
const PLANS: Plan[] = [
  {
    ...
    features: [
      "3 dossiers / jour",
      "Traduction automatique des offres",
      "Profil IA de base",
  ...
  },
  {
    ...
    features: [
      "Dossiers illimités",
      "Jusqu'à 5 profils (par secteur)",
      "Alertes deadline intelligentes",
      "Relance de candidature automatique",
      "Support prioritaire",
    ],
  },
  {
    ...
    features: [
      "Tout le Pro",
      "Génération accélérée (traitement prioritaire)",
